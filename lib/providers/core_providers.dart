...
final secretsProvider = Provider<Map<String,String>>((ref) {
  final Map<String, String> envSecrets = ref.read<EnvType>(envTypeProvider) == EnvType.development ?
    devSecrets : prodSecrets;
   return envSecrets;
});

final iosDeviceInfoProvider = FutureProvider<IosDeviceInfo>((ref) async => await _deviceInfo.iosInfo);
final andDeviceInfoProvider = FutureProvider<AndroidDeviceInfo>((ref) async => await _deviceInfo.androidInfo);
